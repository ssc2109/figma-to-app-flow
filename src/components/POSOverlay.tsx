        ...
        >
          <div className="mx-auto w-full max-w-[430px] h-full flex flex-col">
            ...
            >
              {/* Cart lines */}
              {lines.length > 0 && (
                <div className="max-h-[180px] overflow-y-auto px-[16px] pt-[10px]">
              ...
              <div className="px-[16px] pt-[10px] pb-[16px]">
                <button
                  ...
                  disabled={!canSubmit}
                  onClick={cobrar}
                  className="w-full h-[56px] rounded-[18px] flex items-center justify-between px-[20px] active:scale-[0.98] transition-transform disabled:opacity-30"
                  style={{
                ...
                {lines.length > 0 && (
                  <button
                    type="button"
                    onClick={clearCart}
                    className="w-full h-[36px] mt-[8px] font-['Geist'] text-[12px] text-white/50 active:text-white"
                  >
                    Vaciar venta
                  </button>
                )}
