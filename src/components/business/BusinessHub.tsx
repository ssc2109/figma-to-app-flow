  ...
  return (
    <div className="relative w-full">
      ...
      <div
        ...
        style={{ top: -40, height: 300, opacity: 0.6, maskImage: "linear-gradient(to top, transparent 0%, #000 45%, #000 100%)", WebkitMaskImage: "linear-gradient(to top, transparent 0%, #000 45%, #000 100%)" }}
      >
