...
function Button1() {
  return (
    <div className="absolute glass-card content-stretch flex flex-col items-center justify-center left-[115.09px] px-[24px] py-[8px] rounded-[9999px] top-[8px]" data-name="Button">
...
function Button2() {
  return (
    <div className="absolute glass-card content-stretch flex flex-col items-center justify-center left-[234.27px] px-[24px] py-[8px] rounded-[9999px] top-[8px]" data-name="Button">
      <div className="[word-break:break-word] flex flex-col font-['Geist:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[16px] text-[rgba(255,255,255,0.6)] text-center whitespace-nowrap">
...
function Button3() {
  return (
    <div className="absolute glass-card content-stretch flex flex-col items-center justify-center left-[347.91px] px-[24px] py-[8px] rounded-[9999px] top-[8px]" data-name="Button">
      <div className="[word-break:break-word] flex flex-col font-['Geist:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[16px] text-[rgba(255,255,255,0.6)] text-center whitespace-nowrap">
...
function Button4() {
  return (
    <div className="absolute glass-card content-stretch flex flex-col items-center justify-center left-[436.02px] px-[24px] py-[8px] rounded-[9999px] top-[8px]" data-name="Button">
      <div className="[word-break:break-word] flex flex-col font-['Geist:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[16px] text-[rgba(255,255,255,0.6)] text-center whitespace-nowrap">
