...
function Button() {
  return (
    <div className="bg-white content-stretch flex flex-col items-center justify-center px-[24px] py-[8px] rounded-[9999px] shrink-0" data-name="Button">
...
function Button1() {
  return (
    <div className="bg-[#161616] content-stretch flex flex-col items-center justify-center px-[24px] py-[8px] rounded-[9999px] shrink-0" data-name="Button">
...
function CategoriesChips() {
  return (
    <div className="flex flex-row gap-[12px] overflow-x-auto overflow-y-hidden py-[8px] relative w-full [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]" data-name="Categories Chips">
      <Button />
      <Button1 />
      <Button2 />
      <Button3 />
...
function HeaderTopAppBar() {
  return (
    <div className="relative w-full backdrop-blur-[12px] bg-[rgba(0,0,0,0.8)]" data-name="Header - Top App Bar">
      <Container18 />
    </div>
  );
}
...
export default function HtmlBody() {
  return (
    <div className="flex flex-col size-full bg-black" data-name="Html → Body">
      ...
      {/* Main Content */}
      <div className="mt-[64px] space-y-[16px]">
